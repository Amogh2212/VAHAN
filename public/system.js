...
(() => {
  ...
  if (header) {
    header.innerHTML = `<a class="system-brand" href="/" aria-label="Vahan Analyst overview"><span class="system-mark" aria-hidden="true"><svg viewBox="0 0 32 32" width="22" height="22" fill="none" aria-hidden="true"><path d="M6 6L11.5 6L15.5 19.5L13.5 25L9.5 25Z" fill="#182139"/><path d="M15 25L17.5 18.5L21.5 18.5L19 25Z" fill="#4f46b8"/><path d="M18.8 16.5L21.8 7.5L25.2 7.5L22.2 16.5Z" fill="#6f65ec"/><path d="M23 4.5L25.6 4.5C26.5 4.5 27 5.1 26.8 6L26.2 7.2L23.2 7.2Z" fill="#f27d52"/><path d="M16.5 16L18 11.5L19.5 16L18 15Z" fill="#f6bea5"/></svg></span>Vahan Analyst</a><button type="button" class="nav-toggle" aria-expanded="false" aria-controls="systemNav">Menu</button><nav id="systemNav" class="system-nav" aria-label="Main navigation">${link('/','Overview')}${link('/compare.html','Compare')}${link('/map.html','Map')}<details><summary>RTO workspace ▾</summary><div class="system-menu">${link('/rto-trends.html','Daily trends')}${link('/rto-insights.html','Local insights')}</div></details><details><summary>Reports ▾</summary><div class="system-menu">${link('/rto-reports.html','RTO reports')}${link('/reports/monthly-sales.html','Monthly sales')}</div></details>${link('/tracked.html','Tracked queries')}<details class="system-account"><summary>Account ▾</summary><div class="system-menu">${link('/tracked.html','Account & schedules')}<a href="https://t.me/Vahan_bot" target="_blank" rel="noopener noreferrer">Telegram bot ↗</a>${link('/#queryInput','Ask Vahan')}</div></details></nav>`;
    const accountLink = header.querySelector('.system-account .system-menu a[href="/tracked.html"]');
    if (accountLink) { accountLink.href = '/account.html'; accountLink.textContent = 'Account'; }
