      ...
      payload: {
        ...
        source: {
          ...
          limitation: period.cadence === "daily"
            ? "Daily registration evidence is derived from consecutive source observations. Missing prior-day data can leave the daily value unavailable; the current snapshot is retained for context."
