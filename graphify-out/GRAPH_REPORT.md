...
- `loadMakerRows()` --calls--> `hasDatabaseUrl()`  [INFERRED]
  server.mjs → lib/db.mjs
- `loadCatalog()` --calls--> `hasDatabaseUrl()`  [INFERRED]
  server.mjs → lib/db.mjs
- `persistScrapedRows()` --calls--> `readRegistrationsCsv()`  [INFERRED]
  server.mjs → lib/registrations.mjs
- `persistScrapedRows()` --calls--> `hasDatabaseUrl()`  [INFERRED]
  server.mjs → lib/db.mjs
...
Cohesion: 0.07
Nodes (54): closePool(), connectionStringForPg(), getPool(), query(), shouldUseSsl(), buildRegistrationWhere(), contextValue(), deleteRegistrationContexts() (+46 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (54): appendFileWithRetry(), applyReportSideFilters(), applySideFilters(), assertPrimeCheckboxGroup(), buildReportItems(), buildRtoCatalog(), buildWorkItems(), captureFailureArtifacts() (+46 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (35): buildMonthlySalesReportForUrl(), cleanupJobMap(), cleanupRateLimitBuckets(), cleanupRefreshJobs(), clientIp(), createMapProgress(), enforceRateLimit(), extractScrapedRows() (+27 more)
...
Cohesion: 0.12
Nodes (32): animateCounter(), buildReportCsv(), buildTrendLineChart(), compactFilterEntries(), compactRefreshMessage(), dataStatusLabel(), displayMonth(), downloadBlob() (+24 more)

### Community 6 - "Community 6"
Cohesion: 0.12
Nodes (27): buildMakerRegistrationWhere(), deleteMakerRegistrationContexts(), monthKeyNumber(), parseCsvLine(), queryMakerRegistrationRows(), readLegacyMakerFuelCsv(), readMakerRegistrationsCsv(), readTdcMakerRegistrationsCsv() (+19 more)

### Community 7 - "Community 7"
Cohesion: 0.1
Nodes (32): allowLlmVehicleClass(), allowLlmVehicleGroup(), buildSemanticVocabulary(), closestStateAlias(), combineSemanticPlan(), compact(), decodeWithRules(), exactVocabularyLabels() (+24 more)
...
Cohesion: 0.14
Nodes (25): appBaseUrl(), authCookieName(), clearCookieHeader(), cookieHeader(), createSession(), createTelegramLinkCode(), currentUser(), destroySession() (+17 more)

### Community 10 - "Community 10"
Cohesion: 0.16
Nodes (25): hasDatabaseUrl(), loadRegistrationRowsFromDb(), buildTelegramSummary(), checkTelegramBigChangeAlerts(), csvHealthPayload(), fetchMissingTelegramSummaryRows(), filterMapRows(), freshness() (+17 more)

### Community 11 - "Community 11"
Cohesion: 0.18
Nodes (17): apiJson(), deleteTrackedQuery(), deltaText(), disableTrackedQuery(), displayLabel(), escapeHtml(), latestObservation(), latestRun() (+9 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (22): applyDefaultDateRange(), clampFutureDateRange(), decodeWithAiProviders(), findMissingMonthsFromDb(), groupMonthKeys(), hasRequiredScrapeFilters(), isSameStateLocation(), liveRefreshInfo() (+14 more)
...
Cohesion: 0.38
Nodes (7): dashboardPayload(), dataReliabilityWarning(), filterRows(), filterRowsIgnoringDate(), resolveDataStatus(), resolveImmediateDataStatus(), summarizeScraperRuns()
...
- **Why does `buildMonthlySalesReport()` connect `Community 4` to `Community 2`, `Community 6`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `query()` connect `Community 0` to `Community 9`, `Community 10`, `Community 6`, `Community 15`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `renderMonthlySalesReportHtml()` connect `Community 4` to `Community 2`, `Community 6`?**
