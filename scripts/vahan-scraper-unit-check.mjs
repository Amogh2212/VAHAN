...
import { hasRequestedSideFilters, matchPublicRto, monthsAvailableForYears, parsePublicMonthlyRows, publicDirectMonthlyQueryString, publicMonthlyQueryString, resolveMakerReportTotal } from "./vahan-scraper.mjs";
...
assert.deepEqual(
  monthsAvailableForYears([2026], [6, 7, 8, 9, 10, 11, 12], new Date("2026-09-07T00:00:00+05:30")),
  [6, 7, 8, 9],
  "current-year requests must stop at the present calendar month",
);
assert.deepEqual(
  monthsAvailableForYears([2025], [1, 12], new Date("2026-09-07T00:00:00+05:30")),
  [1, 12],
  "completed years must retain all requested months",
);
